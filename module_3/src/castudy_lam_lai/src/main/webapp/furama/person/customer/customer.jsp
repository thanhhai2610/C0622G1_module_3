                    ...
                    <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                        ...
                        <li class="nav-item">
                            <a style="padding-top: 13%; width: 300px; height: 100px; font-size: 30px;"
                               class="nav-link active px-2"
                               aria-current="page"
                               href="/customer?action=create">Add Customer </a>
                        </li>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a href="/customer" class="btn btn-secondary" data-bs-dismiss="modal">Hủy
                                                                bỏ</a>
                                                            <a class="btn btn-danger"
                                                               href="/customer?action=delete&id=${data.id}">Delete</a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="/customer?action=edit&id=${data.id}" method="post">
                        <fieldset>
