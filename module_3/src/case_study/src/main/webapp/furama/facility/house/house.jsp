...
<head>
    ...
    <link rel="stylesheet" href="/furama/css/home.css">
</head>
<body>
    ...
    <div class="header bg-light ">
        <nav class=" navbar navbar-expand-lg bg-light ">
            <div class="container-fluid">
                <a class="navbar-brand" href="/home"><img style="height: 150px; width: auto;"
                ...
                <div class="collapse navbar-collapse" id="navbarScroll">
                    <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                        <li class="nav-item">
                            <a style="height: 150px; width: auto;font-size: 30px" class="nav-link active px-2"
                               aria-current="page"
                        ...
                        <li class="nav-item">
                            <a style="height: 150px; width: auto;font-size: 30px" class="nav-link active px-2"
                               aria-current="page"
                               href="/emploee"><strong>Emploee</strong> </a>
                        </li>
                        <li class="nav-item">
                            <a style="height: 150px; width: auto;font-size: 30px" class="nav-link active px-2"
                               aria-current="page"
                               href="/customer"><strong>Customer</strong> </a>
                        </li>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                               aria-expanded="false" style="height: 150px; width: auto ;font-size: 30px">
                                Service
                            </a>
