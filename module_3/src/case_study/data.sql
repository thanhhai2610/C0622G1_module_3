-- vị trí
INSERT INTO `furama`.`vi_tri` ( `ten_vi_tri`) VALUES
( 'Quản Lý'),
( 'Nhân Viên');
-- trình độ
INSERT INTO `furama`.`trinh_do` (`ten_trinh_do`) VALUES 
( 'Trung Cấp'),
( 'Cao Đẳng'),
( 'Đại Học'),
( 'Sau Đại Học');
-- kiểu thuê
INSERT INTO `furama`.`kieu_thue` ( `ten_kieu_thue`) VALUES
('year'),
('month'),
('day'),
('hour');
-- loại dịch vụ
INSERT INTO `furama`.`loai_dich_vu` (`ten_loai_dich_vu`) VALUES 
('Villa'),
('House'),
('Room');
-- dịch vụ
INSERT INTO `furama`.`dich_vu` ( `ten_dich_vu`, `dien_tich`, `chi_phi_cho_thue`, `so_nguoi_toi_da`, `ma_kieu_thue`, `ma_loai_dich_vu`, `tieu_chuan_phong`, `mo_ta_tien_nghi`, `dien_ho_boi`, `so_tang`, `dich_vu_mien_phi_di_kem`) VALUES 
...
-- dịch vụ kèm theo 
INSERT INTO `furama`.`dich_vu_kem_theo` (`ten_dich_vu_kem_theo`, `gia`, `don_vi`, `trang_thai`) VALUES
...
-- bộ phận 
 INSERT INTO `furama`.`bo_phan` ( `ten_bo_phan`) VALUES
( 'Sale-Marketing'),
( 'Hành chính'),
( 'Phục vụ'),
( 'Quản lý');
...
('Member');
-- khách hàng
INSERT INTO `furama`.`khach_hang` ( `ma_loai_khach`, `ho_va_ten`, `ngay_sinh`, `gioi_tinh`, `so_cmnd`, `so_dien_thoai`, `emai`, `dia_chi`) VALUES 
